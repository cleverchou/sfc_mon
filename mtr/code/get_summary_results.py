...
if __name__ == "__main__":
    ...
    path_gumbel = str(cal_size) + "_results_gumbel_rf_conf_levels.json"#"_results_gumbel_rf_conf_levels.json" #"_results_gumbel_nn_conf_levels.json"
    path_empirical = str(cal_size) + "_results_empirical_rf_conf_levels.json"#"_results_empirical_rf_conf_levels.json" #"_results_empirical_nn_conf_levels.json"
    path_independent = str(cal_size) + "_results_independent_rf_conf_levels.json"#"_results_independent_rf_conf_levels.json" #"_results_independent_nn_conf_levels.json"
    ...
    path_independent = str(cal_size) + "_results_independent_rf_conf_interval.json"#"_results_independent_rf_conf_interval.json" #"_results_independent_nn_conf_interval.json"
    path_gumbel = str(cal_size) + "_results_gumbel_rf_conf_interval.json" #"_results_gumbel_rf_conf_interval.json" #"_results_gumbel_nn_conf_interval.json"
    path_empirical = str(cal_size) + "_results_empirical_rf_conf_interval.json" #"_results_empirical_rf_conf_interval.json" #"_results_empirical_nn_conf_interval.json"
    config_path = "config.json"
